...
df_minmax.to_csv('EKG_pupsniu_analize_normuota_pagal_minmax.csv', index=False, sep=';')
...
df_z_reiksme.to_csv('EKG_pupsniu_analize_normuota_pagal_vidurki_ir_dispersija.csv', index=False, sep=';')